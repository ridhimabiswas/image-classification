...
def convertToInteger(data):
    """
    Helper function for file reading.
    If data is a list, it recursively converts each element.
    If data is not a list, it applies IntegerConversionFunction.
    """
    if isinstance(data, list):  #check if data is a list
        return [convertToInteger(item) for item in data]
    else:
